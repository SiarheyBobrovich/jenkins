...
INSERT INTO persons (id, surname, name, residency_id, uuid)
values (1, 'Бобрович', 'Сергей', 1, 'f4fe3df1-22cd-49ce-a54d-86f55a7f372e'),
       (2, 'Бобрович', 'Дарья', 1, '590f83e1-da56-4f23-a448-da4edaacba7c'),
       (3, 'Бобрович', 'Павел', 1, '183e02cd-6f59-44ad-8fef-d23997cf712a'),
       (4, 'Бобрович', 'Светлана', 2, '6ea03fcc-c6f1-45e5-8e38-a49ad0dfb762'),
       (5, 'Бобрович', 'Александр', 2, '758d003d-b913-41b5-b9c1-8993922e91f7');
